...
class UserAssetsSearch extends React.Component {
  static propTypes = {
  ...
  searchData() {
    if (this.props.searchData.count() > 1) {
      ...
      return this.props.form.setFields({
        coin_id: dataSource1.get('coin_id'),
      });
    }
    return false;
  }
  resetFieldAction() {
    ...
    this.props.changeAction('UserAssetsReducer/searchData/coin_id', '');
    this.props.changeAction('UserAssetsReducer/searchData/pageNum', 1);
  }
  render() {
          ...
          <Col span="8" >
            ...
            >
              {getFieldDecorator('id', {
                  initialValue: this.props.searchData.get('coin_id'),
                  onChange: (e) => {
                    this.props.changeAction(
                    'UserAssetsReducer/searchData/coin_id', e.target.value);
                  },
                })(
                <Input
                  placeholder="ID"
...
export default Form.create()(UserAssetsSearch);
