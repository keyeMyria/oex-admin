...
class CurrencyInfoListSearch extends React.Component {
  static propTypes = {
            ...
            >
              {getFieldDecorator('type', {
                  ...
                  >
                    ...
                    <Option value={3}>高分经验</Option>
                    <Option value={4}>报考指南</Option>
                  </Select>
              )}
            </FormItem>
          </Col>
...
export default Form.create()(CurrencyInfoListSearch);
