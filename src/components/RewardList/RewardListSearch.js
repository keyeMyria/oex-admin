...
class RewardListSearch extends React.Component {
  static propTypes = {
  ...
  resetFieldAction() {
    ...
    this.props.changeAction('RewardReducer/searchData/id', '');
    this.props.changeAction('RewardReducer/searchData/phone', '');
    this.props.changeAction('RewardReducer/searchData/realName', '');
    this.props.changeAction('RewardReducer/searchData/pageNum', 1);
  }
  render() {
            ...
            >
              {getFieldDecorator('id', {
                  ...
                  onChange: (e) => {
                    ...
                    'RewardReducer/searchData/id', e.target.value);
                  },
                })(
                <Input
                  placeholder="ID"
          ...
          <Col span="8" >
            ...
            >
              {getFieldDecorator('realName', {
                  ...
                  onChange: (e) => {
                    this.props.changeAction(
                    'RewardReducer/searchData/realName', e.target.value);
                  },
                })(
                <Input
                  placeholder="昵称"
          ...
          <Col span="8" >
            ...
            >
              {getFieldDecorator('phone', {
                  ...
                  onChange: (e) => {
                    this.props.changeAction(
                    'RewardReducer/searchData/phone', e.target.value);
                  },
                })(
                <Input
                  placeholder="手机号"
          ...
          <Col span="8" >
            ...
            >
              {getFieldDecorator('style', {
                  ...
                  onChange: (e) => {
                    this.props.changeAction(
                    'RewardReducer/searchData/style', e);
                  },
                })(
                  <Select
                    placeholder="请选择"
...
export default Form.create()(RewardListSearch);
