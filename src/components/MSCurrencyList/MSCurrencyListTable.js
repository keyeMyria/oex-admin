...
class MSCurrencyListTable extends React.Component {
        ...
        operation: (
          <View>
            <a
              onClick={(e) => {
                e.preventDefault();
                this.props.dispatch(push(RoutingURL.ExperienceMedicine(data.get('id'), true)));
              }}
            >
              编辑
            </a>&nbsp;&nbsp;&nbsp;
...
MSCurrencyListTable.propTypes = propTypes;

export default MSCurrencyListTable;
