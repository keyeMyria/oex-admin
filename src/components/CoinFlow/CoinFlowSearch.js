...
class CoinFlowSearch extends React.Component {
  static propTypes = {
  ...
  resetFieldAction() {
    ...
    this.props.changeAction('FlowReducer/coinSearchData/coin_id', '');
    this.props.changeAction('FlowReducer/coinSearchData/pageNum', 1);
  }
  render() {
            ...
            >
              {getFieldDecorator('id', {
                  ...
                  onChange: (e) => {
                    ...
                    'FlowReducer/coinSearchData/coin_id', e.target.value);
                  },
                })(
                <Input
                  placeholder="ID"
...
export default Form.create()(CoinFlowSearch);
